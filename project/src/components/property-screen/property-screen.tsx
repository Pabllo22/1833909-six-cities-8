...
import ListReview from '../list-reviews/list-reviews';
...
import Map from '../main-screen/map';
...
function PropertyScreen({answersRevies, points, rooms, answersCards}: ListReviewScreen): JSX.Element {
  const [oneReview] = answersRevies;
  const [oneRoom] = rooms;
          ...
          <div className="property__container container">
            <div className="property__wrapper">
              ...
              <section className="property__reviews reviews">
                <h2 className="reviews__title">Reviews &middot; <span className="reviews__amount">{oneReview.reviewsviews.length}</span></h2>
                <ul className="reviews__list">
                  <ListReview answers={oneReview as reviewAnswer}/>
                </ul>
                <FormReviews />
              </section>
            </div>
